...
- Digite 3 para Transtorno do Espectro Autista/Neurodivergente
- Digite 4 para Deficiência física
- Digite 5 para Não tenho deficiência, mas tenho mobilidade reduzida
